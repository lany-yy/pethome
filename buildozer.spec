...
# Set this if you want to use local copy of a requirement
...
# use that parameter to add activity, receiver, service or other application elements
#android.add_application_xml =
...
#    Let's take [app] / requirements as example:
#
#    [app]
